# ApplAudition.Tests - Tests Unitaires

## Vue d'ensemble

Projet de tests unitaires xUnit pour ApplAudition (Phase 10).
...
dotnet test ApplAudition.Tests\ApplAudition.Tests.csproj --logger "console;verbosity=detailed"
```
...
- ✅ Créé projet ApplAudition.Tests
